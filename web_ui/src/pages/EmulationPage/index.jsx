  ...
  return (
    <div class={styles['root']}>
      <div class={styles['card']}>
        ...
        <p>
          File operations are disabled while the host owns the SD card. Switch to HTTP mode
          only when the host is idle or safely ejected.
        </p>
        {info?.wifi.connected === true && <p class={styles['meta']}>Device IP: {info.wifi.ip}</p>}
        <button disabled={isSwitching} type="button" onClick={switchToHttp}>
