...
│   │   ├── bsp_pins.h
│   │   ├── bsp_led.h / bsp_led.c    // APA102 control
│   │   └── bsp_lcd.h / bsp_lcd.c    // ST7735 (lvgl or minimal fb)
│   ├── storage/
...
ST7735 80x160 (portrait) — very little space, use a compact layout. Font 8x16 → 10 characters per line × 10 lines.
